...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/etable/v2/etview.TensorLayout",
...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/etable/v2/etview.TensorDisp",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Range", &gti.Field{Name: "Range", Type: "github.com/emer/etable/v2/minmax.Range64", LocalType: "minmax.Range64", Doc: "range to plot", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"MinMax", &gti.Field{Name: "MinMax", Type: "github.com/emer/etable/v2/minmax.F64", LocalType: "minmax.F64", Doc: "if not using fixed range, this is the actual range of data", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		...
		{"GridView", &gti.Field{Name: "GridView", Type: "*github.com/emer/etable/v2/etview.TensorGrid", LocalType: "*TensorGrid", Doc: "our gridview, for update method", Directives: gti.Directives{}, Tag: "copy:\"-\" json:\"-\" xml:\"-\" view:\"-\""}},
	}),
	Embeds: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"TensorLayout", &gti.Field{Name: "TensorLayout", Type: "github.com/emer/etable/v2/etview.TensorLayout", LocalType: "TensorLayout", Doc: "", Directives: gti.Directives{}, Tag: ""}},
	}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
