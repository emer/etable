...
var Plot2DType = gti.AddType(&gti.Type{
	Name:      "github.com/emer/etable/v2/eplot.Plot2D",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Table", &gti.Field{Name: "Table", Type: "*github.com/emer/etable/v2/etable.IdxView", LocalType: "*etable.IdxView", Doc: "the idxview of the table that we're plotting", Directives: gti.Directives{}, Tag: "set:\"-\""}},
		{"Params", &gti.Field{Name: "Params", Type: "github.com/emer/etable/v2/eplot.PlotParams", LocalType: "PlotParams", Doc: "the overall plot parameters", Directives: gti.Directives{}, Tag: ""}},
		{"Cols", &gti.Field{Name: "Cols", Type: "[]*github.com/emer/etable/v2/eplot.ColParams", LocalType: "[]*ColParams", Doc: "the parameters for each column of the table", Directives: gti.Directives{}, Tag: "set:\"-\""}},
	...
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{
		...
		{"SaveCSV", &gti.Method{Name: "SaveCSV", Doc: "SaveCSV saves the Table data to a csv (comma-separated values) file with headers (any delim)", Directives: gti.Directives{
			...
			{"fname", &gti.Field{Name: "fname", Type: "goki.dev/gi.FileName", LocalType: "gi.FileName", Doc: "", Directives: gti.Directives{}, Tag: ""}},
			{"delim", &gti.Field{Name: "delim", Type: "github.com/emer/etable/v2/etable.Delims", LocalType: "etable.Delims", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		}), Returns: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{})}},
...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/etable/v2/eplot.PlotParams",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Type", &gti.Field{Name: "Type", Type: "github.com/emer/etable/v2/eplot.PlotTypes", LocalType: "PlotTypes", Doc: "type of plot to generate.  For a Bar plot, items are plotted ordinally by row and the XAxis is optional", Directives: gti.Directives{}, Tag: ""}},
		...
		{"PointShape", &gti.Field{Name: "PointShape", Type: "github.com/emer/etable/v2/eplot.Shapes", LocalType: "Shapes", Doc: "the shape used to draw points", Directives: gti.Directives{}, Tag: ""}},
		...
		{"Plot", &gti.Field{Name: "Plot", Type: "*github.com/emer/etable/v2/eplot.Plot2D", LocalType: "*Plot2D", Doc: "our plot, for update method", Directives: gti.Directives{}, Tag: "copy:\"-\" json:\"-\" xml:\"-\" view:\"-\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/etable/v2/eplot.ColParams",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Range", &gti.Field{Name: "Range", Type: "github.com/emer/etable/v2/minmax.Range64", LocalType: "minmax.Range64", Doc: "effective range of data to plot -- either end can be fixed", Directives: gti.Directives{}, Tag: ""}},
		{"FullRange", &gti.Field{Name: "FullRange", Type: "github.com/emer/etable/v2/minmax.F64", LocalType: "minmax.F64", Doc: "full actual range of data -- only valid if specifically computed", Directives: gti.Directives{}, Tag: ""}},
