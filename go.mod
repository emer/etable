...
require (
	...
	goki.dev/colors v0.8.39
	goki.dev/enums v0.9.51
	goki.dev/gi/v2 v2.0.0-dev0.0.24
...
require (
	...
	goki.dev/cam v0.9.45 // indirect
	goki.dev/cursors v0.0.28 // indirect
	goki.dev/fi v0.1.14 // indirect
	goki.dev/grog v0.0.23 // indirect
	goki.dev/grows v0.3.26 // indirect
